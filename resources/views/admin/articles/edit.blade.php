        ...
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            ...
            <div>
                ...
                <p class="mt-1 text-xs text-slate-500 max-w-2xl">
                    Perbarui informasi dan konten artikel:
        ...
        <section class="rounded-2xl bg-white border border-slate-200 shadow-sm overflow-hidden">
            ...
            <div class="px-5 sm:px-6 py-4 border-b border-slate-100">
                ...
                <p class="mt-0.5 text-[11px] text-slate-400">
                    Perbarui judul, ringkasan, dan isi utama artikel.
                </p>
            ...
            <div class="p-5 sm:p-6">
                ...
                @if ($article->image)
                    ...
                    <div class="mt-6">
                        ...
                        <p class="mb-2 text-xs font-bold text-slate-700">
                            Gambar Saat Ini
                        </p>
                        ...
                        <div class="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                            ...
                            <div class="flex flex-col sm:flex-row sm:items-center gap-4">
                                ...
                                <div class="w-full sm:w-48 h-32 rounded-xl overflow-hidden bg-white border border-slate-200">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs font-bold text-[#00294B]">
                ...
                <div class="mt-6">
                    ...
                    <label
                        ...
                        {{ $article->image ? 'Ganti Featured Image' : 'Featured Image' }}
