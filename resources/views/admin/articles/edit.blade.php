...
@section('content')
    <div class="container mx-auto px-4">
        <h1 class="text-3xl font-semibold mb-6">Edit Article: {{ $article->title }}</h1>
        ...
        <form action="{{ route('admin.articles.update', $article) }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="mb-4">
                ...
                @if ($article->image)
                    <img src="{{ asset('storage/' . $article->image) }}" alt="{{ $article->title }}" class="mb-2 w-64">
                @endif
                <input
            ...
            <div class="mb-4">
                ...
                <input
                    ...
                    id="published_at" type="datetime-local" name="published_at"
