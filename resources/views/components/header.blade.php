    ...
    <div class="container mx-auto px-4 text-white pt-2">
        <div class="flex justify-between items-center py-2 text-[10px]">
            <div class="flex items-center space-x-4 text-[10px] md:text-xs">
                ...
                <a href="tel:+6281110119273" class="hover:text-secondary transition duration-300 hidden md:block">
                    <i class="fas fa-phone md:mr-2"></i>+62 811 10119273
                </a>
            </div>
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="https://registrasi.fitalenta.co.id/register"
                            class="px-3 py-2 rounded-md text-sm font-medium hover:bg-[#003a6b] ">Registrasi</a>
                    </div>
                </div>
